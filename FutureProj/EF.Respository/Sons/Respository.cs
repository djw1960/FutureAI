...
namespace EF.Respository.Sons
{
    ...
    public partial class FSys_Category:BaseRespository<EF.Entitys.FSys_Category>,EF.IRespository.Sons.IFSys_Category
    {
    
    }
    public partial class FMoments:BaseRespository<EF.Entitys.FMoments>,EF.IRespository.Sons.IFMoments
    {
    ...
    public partial class FSysUser_Invite:BaseRespository<EF.Entitys.FSysUser_Invite>,EF.IRespository.Sons.IFSysUser_Invite
    {
